...
def cleanString(strin): #strin = string input
...
#legge il file e pulisce la stringa
originale=readfile("promessi.txt")
pulita=cleanString(originale)

reportOut(pulita,"out.txt")